            ...
            <>
                ...
                <div className='mb-16 mt-8 p-3 grid grid-cols-1 md:grid-cols-3 gap-5  items-center'>
                    <div className='text-center mb-12 rounded-full bg-opacity-0 hover:bg-opacity-50 md:hover:bg-opacity-0 duration-300 bg-grey'>
                        <img className='w-3/5 md:w-2/6  m-auto' src={require('../assets/images/property-listings/illustration1.svg')} />
                    ...
                    <div className='text-center mb-12 rounded-full bg-opacity-0 hover:bg-opacity-50 md:hover:bg-opacity-0 duration-300 bg-grey'>
                        <img className='w-3/5 md:w-2/6  m-auto' src={require('../assets/images/property-listings/illustration2.svg')} />
...
Give zanga users incentive to share your property. </p>
                    ...
                    <div className='text-center mb-12 rounded-full bg-opacity-0 hover:bg-opacity-50 md:hover:bg-opacity-0 duration-300 bg-grey'>
                        <img className='w-3/5 md:w-2/6  m-auto' src={require('../assets/images/property-listings/illustration3.svg')} />
