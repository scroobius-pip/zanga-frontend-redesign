    ...
    <Layout user={{ id: '', image: session?.user.image, name: session?.user.name, type: UserType.Unassigned }}>
      <div >
        ...
        <div className='grid max-w-4xl  sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-5 m-auto w-full my-10'>
            ...
            <a href='/earn-login' className='outline-none block'>
              <>
                ...
                Start Earning
                  ...
                  <a href='/earn-login'>
                    <Button className='mt-5' variant='primary' text='Start Earning' icon='Right' onClick={() => window.location.replace('/earn-login')} />
                  </a>
          ...
          <Card className='hover:-translate-y-3 cursor-pointer duration-300  transform flex flex-col sm:flex-row lg:flex-col items-end'>
              ...
              <>
                ...
                <div className='relative'>
                  ...
                  <a href='/listing-login'>
                    ...
                    <Button className='mt-5' variant='primary' text='Advertise Property' icon='Right' onClick={() => window.location.replace('/listing-login')} />
                  </a>
