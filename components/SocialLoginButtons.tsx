...
export default () => {
    return <div className='w-full'>
        ...
        <button onClick={() => signin('facebook', { callbackUrl: 'http://localhost:3000/dashboard' })} className=' bg-grey-light focus:outline-none p-5 w-full duration-150 hover:shadow-sm opacity-75 hover:opacity-100 flex justify-center items-center'>
