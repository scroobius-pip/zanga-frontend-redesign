            ...
            <div className=' w-full mb-5 grid grid-cols-1  sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  gap-5'>
                ...
                <div className='w-full '>
                    <Dropdown
                        ...
                        label='Type'
                        onChange={(type) => { setFilters({ ...filters, type: CostType[type] }) }}
                ...
                <div className='flex items-end '>
                    <a href={`/properties?state=${filters.state}&type=${filters.type}&budget=${filters.budget ?? 0}`}>

                        <Button preventDefault={false} variant='primary' text='Search' icon='Search' onClick={() => { }} />
                    </a>
                </div>
            </div>
