...
export default () => {
    return <footer className='bg-grey-light text-center'>
        ...
        <span className='text-blue opacity-25'>version 0.14</span>
        <div className='flex justify-between align-middle mb-5 flex-col max-w-screen-sm m-auto sm:flex-row'>
            ...
            <a className='font-pop text-blue opacity-50 hover:opacity-100' href="/legal#terms">Terms & Conditions</a>
            <a className='font-pop text-blue opacity-50 hover:opacity-100' href="/legal#privacy">Privacy Policy</a>
